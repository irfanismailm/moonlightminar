...
/* When the user scrolls down, hide the navbar. When the user scrolls up, show the navbar
    ...
    if (prevScrollpos > currentScrollPos) {
        document.getElementById("section__header").style.top = "0";
    } else {
        document.getElementById("section__header").style.top = "-500px";
    }
...
if ((st > lastScrollTop) && (lastScrollTop>0)) {
       // downscroll code
      $("section__header flex flex--wrap flex__header").css("top","-100px");
  
   } else {
      // upscroll code
      $("section__header flex flex--wrap flex__header").css("top","0px");
   }
       lastScrollTop = st;
    });
});
